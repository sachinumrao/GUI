...
class plottype3:
    def __init__(self,master):
        print("Offline_graph for pvdf called")

    def plot3(self, master, data):

        self.master = master
        self.data = data
        self.sensor_name = "PVDF"
        self.master.title("Pipeline Health Monitoring Robot: Offline Mode: PVDF Sensor Data")
        ...
        self.fig.suptitle("PVDF Sensor Data")
...
############################################################################################
        ...
        #self.fig.text(0.5, 0.04, 'Distance', ha='center', va='center')
        ...
        self.led_button = tk.Button(self.frame2, text="LED-LDR Data", bg="gray", bd=2,relief="raised",
                                    command= lambda: self.led_viewer())

        self.led_button.place(x = self.x/4+20 , y=10)
